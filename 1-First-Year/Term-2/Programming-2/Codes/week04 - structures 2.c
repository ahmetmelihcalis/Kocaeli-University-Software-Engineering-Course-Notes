...
int main() {
    ...
    printf("1st complex number: %.2f + %.2fi\n", number1.real, number1.imaginary);
    printf("2nd complex number: %.2f + %.2fi\n", number2.real, number2.imaginary);
...
int main() {
    ...
    printf("Enter details for the 1st car:\n");
    printf("Car ID: ");
    scanf("%d", &car1.carID);
    printf("Model: ");
    ...
    printf("Enter details for the 2nd car:\n");
    printf("Car ID: ");
    scanf("%d", &car2.carID);
    printf("Model: ");
    ...
    printf("Enter details for the 3rd car:\n");
    printf("Car ID: ");
    scanf("%d", &car3.carID);
    printf("Model: ");
